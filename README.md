...
Para criar a tag, simular, implantar, verificar e executar rollback, siga o
[runbook operacional de atualização](UPDATE.md).

Esse fluxo pressupõe que a estação DEV e a VM já estejam preparadas. Para
instalação inicial ou configuração de WinRM, Kerberos, firewall, permissões e
acesso Git, consulte o [guia de instalação](INSTALL.md).
